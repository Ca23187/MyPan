...
Source Database       : mypan

Target Server Type    : MYSQL
Target Server Version : 80041
File Encoding         : 65001

Date: 2026-04-23 15:58:17
*/
...
CREATE TABLE `file_info` (
  ...
  `recycled_at` datetime DEFAULT NULL COMMENT '回收站时间',
  `del_flag` tinyint(1) DEFAULT '2' COMMENT '删除标记 0:删除 1:回收站 2:正常 3:回收站子类',
  ...
  KEY `idx_recycled_at` (`recycled_at`) USING BTREE
...
CREATE TABLE `file_share` (
  ...
  `file_id` varchar(10) NOT NULL COMMENT '文件ID',
  `user_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户ID',
  `expire_type` tinyint(1) DEFAULT NULL COMMENT '有效期类型 0:1天 1:7天 2:30天 3:永久有效',
  ...
  KEY `idx_user_id` (`user_id`),
  KEY `idx_shared_at` (`shared_at`) USING BTREE
...
CREATE TABLE `user_info` (
  ...
  `used_space` bigint DEFAULT '0' COMMENT '使用空间单位byte',
  `total_space` bigint DEFAULT NULL COMMENT '总空间',
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `key_email` (`email`),
  UNIQUE KEY `key_nick_name` (`nickname`),
