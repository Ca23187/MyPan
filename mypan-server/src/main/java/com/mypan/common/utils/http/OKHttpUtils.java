package com.mypan.common.utils.http;
...
public final class OKHttpUtils {
    ...
    public static String getRequest(String url, Map<String, String> headers) throws BusinessException {
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            if (LOG_BODY && log.isInfoEnabled()) {
                log.info("OKHttp GET URL: {}, headers: {}, 返回: {}", url, headers, result);
            } else {
                log.info("OKHttp GET URL: {}, headers: {}, status: {}", url, headers, response.code());
            }
            ...
            log.error("OKHttp GET 请求超时, URL: {}", url, e);
            throw new BusinessException(ResponseCodeEnum.INTERNAL_ERROR);
        } catch (Exception e) {
            log.error("OKHttp GET 请求异常, URL: {}", url, e);
            throw new BusinessException(ResponseCodeEnum.INTERNAL_ERROR);
        }
    }
    ...
    private static String post(String url,
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            if (LOG_BODY && log.isInfoEnabled()) {
                log.info("OKHttp {} URL: {}, headers: {}, 参数: {}, 返回: {}",
                        type, url, headers, logParams, result);
            } else {
                log.info("OKHttp {} URL: {}, headers: {}, 参数: {}, status: {}",
            ...
            log.error("OKHttp {} 请求超时, URL: {}, 参数: {}", type, url, logParams, e);
            throw new BusinessException(ResponseCodeEnum.INTERNAL_ERROR);
        } catch (Exception e) {
            log.error("OKHttp {} 请求异常, URL: {}, 参数: {}", type, url, logParams, e);
            throw new BusinessException(ResponseCodeEnum.INTERNAL_ERROR);
        }
    }
